...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Mini Agent - AI assistant with file tools and skill support",
    ...
    if config.tools.enable_skills:
        ...
        try:
            ...
            if skills_path.is_absolute():
                ...
                # 1. Current directory (dev mode: ./skills or ./tuningagent/skills)
                # 2. Package directory (installed: site-packages/tuningagent/skills)
                search_paths = [
                    skills_path,  # ./skills for backward compatibility
                    Path("tuningagent") / skills_path,  # ./tuningagent/skills
                    Config.get_package_dir() / skills_path,  # site-packages/tuningagent/skills
                ]
