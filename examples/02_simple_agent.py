...
from tuningagent.tools import BashTool, EditTool, ReadTool, WriteTool
...
async def demo_file_creation():
    ...
    # Load configuration
    config_path = Path("tuningagent/config/config.yaml")
    if not config_path.exists():
        print("❌ config.yaml not found. Please set up your API key first.")
        print("   Run: cp tuningagent/config/config-example.yaml tuningagent/config/config.yaml")
        return
    ...
    with tempfile.TemporaryDirectory() as workspace_dir:
        ...
        system_prompt_path = Path("tuningagent/config/system_prompt.md")
